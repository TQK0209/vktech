...
<div id="header_wrapper">
  <header id="header" class="clearfix">
    ...
    <div class="region-search-container">
      <div class="search-button-toggle"><i class="fa fa-search" aria-hidden="true"></i></div>
...
<?php if ($page['content'] || $page['sidebar_first'] || $page['sidebar_second'] || $title ): ?>
<div id="page-wrap">
...
<?php if ($page['content_1']): ?>
  <div id="content-1">
    <div id="block-content-1" class="hkt-block-contents">
...
<?php if ($page['content_2']): ?>
  <div id="content-2">
    <div id="block-content-2" class="hkt-block-contents">
...
<?php if ($page['content_3']): ?>
  <div id="content-3">
    <div id="block-content-3" class="hkt-block-contents">
...
<?php if ($page['content_4']): ?>
  <div id="content-4">
    <div id="block-content-4" class="hkt-block-contents">
...
<?php if ($page['content_5']): ?>
  <div id="content-5">
    <div id="block-content-5" class="hkt-block-contents">
...
<?php if ($page['content_6']): ?>
  <div id="content-6">
    <div id="block-content-6" class="hkt-block-contents">
...
<?php if ($page['content_7']): ?>
  <div id="content-7">
    <div id="block-content-7" class="hkt-block-contents">
...
<?php if ($page['content_8']): ?>
  <div id="content-8">
    <div id="block-content-8" class="hkt-block-contents">
...
<?php if ($page['content_9']): ?>
  <div id="content-9">
    <div id="block-content-9" class="hkt-block-contents">
...
<?php if ($page['content_10']): ?>
  <div id="content-10">
    <div id="block-content-10" class="hkt-block-contents">
...
<div id="footer">
  ...
  <div class="footer_credit">
    ...
    <div id="copyright" class="full-wrap clearfix">
      <div class="copyright">&copy; <?php echo date("Y"); ?> <?php print $site_name; ?>. Bản quyền thuộc về HKT-Team.</div> 
